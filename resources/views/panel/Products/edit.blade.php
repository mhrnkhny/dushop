    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Products / update</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" enctype="multipart/form-data" action="{{route('product.update',['product'=>$products->id])}}" method="post">
                @csrf
                @method('put')
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input name="name" type="text" class="form-control" id="name" value="{{$products->name}}">
                    </div>
                    <div class="form-group">
                        <label for="product_key">product_key</label>
                        <input name="product_key" type="text" class="form-control" id="product_key"
                               value="{{$products->product_key}}">
                    </div>
                    <div class="form-group">
                        <label for="seller">seller</label>
                        <input name="seller" type="text" class="form-control" id="seller" value="{{$products->seller}}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input name="number" type="number" class="form-control" id="number" value="{{$products->number}}">
                    </div>
                    <div class="form-group">
